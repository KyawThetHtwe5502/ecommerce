...
import { app, cartBody, cartBox, cartBtn, cartItem, productCard, productList } from "../core/selectors"
...
export const stars = (rate) => {
    ...
    for (let i = 1; i <= 5; i++) {
        starUi += `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-orange-400 ${i <= rate.toFixed(0) && 'fill-orange-400'}">
...
export const productListHandler = (event) => {
    if (event.target.classList.contains("add-to-cart")) {
        ...
        // console.log(currentProduc);
        // addToCart(currentProductId)
        // cartBody.append(createCartItem());
